...
export default function AcceptableUseMobile() {
  return (
    <Layout title="Hello" description="Hello React Page">
      <div className="p-20 policies">
        ...
        <p>
          ...
          provided by Rawbytes Technologies under any ongoing agreement. It’s
          designed to protect us, our customers, and the general Internet
          community from unethical, irresponsible, and illegal activity.{" "}
        </p>
        <p>
          Rawbytes Technologies customers found engaging in activities
        ...
        <p>This policy was last reviewed on 12 February 2022. </p>
        <h3>Fair use</h3>
        <p>
        ...
        <h4>Unauthorized use of Rawbytes Technologies property</h4>
        <p>
          We prohibit the impersonation of Rawbytes Technologies, the
          representation of a significant business relationship with Rawbytes
          Technologies, or ownership of any Rawbytes Technologies property
