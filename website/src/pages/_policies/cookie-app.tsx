...
export default function CookieMobile() {
  return (
    <Layout title="Hello" description="Hello React Page">
      <div className="p-20 policies">
        ...
        <p>
          ...
          <a href="https://hissab.io">https://hissab.io</a>. This cookie policy
          is part of Rawbytes Technologies&#39; privacy policy. It covers the
        ...
        <p>
          ...
          <a href="https://hissab.io">https://hissab.io</a>. In such a case, we
