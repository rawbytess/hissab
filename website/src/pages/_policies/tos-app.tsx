...
export default function TOSMobile() {
  return (
    <Layout title="Hello" description="Hello React Page">
      <div className="p-20 policies">
        <h2>Mobile App Terms of Service</h2>
        <p>
          These Terms of Service govern your use of Hissab, our website located
          at <a href="https://hissab.io">https://hissab.io</a>, and any related
          services provided by Rawbytes Technologies.{" "}
        </p>
        <p>
          When you use Hissab, you agree to abide by these Terms of Service and
          to comply with all applicable laws and regulations. If you do not
          agree with these Terms of Service, you are prohibited from further
          using the app, accessing our website, or using any other services
          provided by Rawbytes Technologies.{" "}
        </p>
        <p>
          If you access or download Hissab from (1) the Apple App Store, you
          agree to any Usage Rules set forth in the App Store Terms of Service;
          and/or (2) the Google Play Store, you agree to the Android, Google
          Inc. Terms and Conditions including the Google Apps Terms of Service.{" "}
        </p>
        <p>
          We, Rawbytes Technologies, reserve the right to review and amend any
          of these Terms of Service at our sole discretion. Upon doing so, we
          will update this page and notify you through the app and/or the email
        ...
        <p>These Terms of Service were last updated on 12 February 2022. </p>
        <h3>Limitations of Use</h3>
        <p>
          By using Hissab and our website, you warrant on behalf of yourself,
        ...
        <ol>
          <li>
            ...
            engineer Hissab or any materials and software contained within
            Hissab or on our website;
          </li>
          <li>
            remove any copyright or other proprietary notations from Hissab or
            any materials and software contained within Hissab or on our
            website;
          </li>
          <li>
            transfer Hissab or any of its associated materials to another person
            or “mirror” the materials on any other server;
          </li>
          <li>
            knowingly or negligently use Hissab or any of its associated
            services in a way that abuses or disrupts our networks or any other
            service Rawbytes Technologies provides;
          </li>
          <li>
            use Hissab or its associated services to transmit or publish any
            harassing, indecent, obscene, fraudulent, or unlawful material;
          </li>
          <li>
            use Hissab or its associated services in violation of any applicable
            laws or regulations;
          </li>
          <li>use Hissab to send unauthorized advertising or spam;</li>
          <li>
            harvest, collect, or gather user data without the user’s consent; or
          </li>
          <li>
            use Hissab or its associated services in such a way that may
        ...
        <p>
          The intellectual property in the materials in Hissab and on our
          website are owned by or licensed to Rawbytes Technologies. You may
          download Hissab, to view, use, and display the application on your
        ...
        <p>
          ...
          Rawbytes Technologies at any time.{" "}
        </p>
        <h3>Automatic Updates</h3>
        <p>
          You give us permission to download and install updates to Hissab on
          your device in accordance with your privacy preferences. This
          permission can be revoked at any time by deleting Hissab from your
          device.{" "}
        </p>
        <h3>Liability</h3>
        <p>
          Hissab and the materials in Hissab and on our website are provided on
          an 'as is' basis. To the extent permitted by law, Rawbytes
        ...
        <p>
          In no event shall Rawbytes Technologies or its suppliers be liable for
          any consequential loss suffered or incurred by you or any third party
          arising from the use or inability to use Hissab, our website, or any
          other services provided by Rawbytes Technologies or the materials in
          Hissab, even if Rawbytes Technologies or an authorized representative
        ...
        <p>
          The materials appearing in Hissab or on our website are not
          comprehensive and are for general information purposes only. To the
          extent permitted by law, Rawbytes Technologies does not warrant or
          make any representations concerning the accuracy, likely results, or
          reliability of the use of the materials in Hissab or on our website,
          or otherwise relating to such materials or on any resources linked to
          Hissab and our website.{" "}
        </p>
        <h3>Links</h3>
        <p>
          Rawbytes Technologies has not reviewed all of the sites linked to
          Hissab or on its corresponding website and is not responsible for the
          contents of any such linked site. The inclusion of any link does not
          imply endorsement, approval, or control by Rawbytes Technologies of
        ...
        <p>
          To the extent that you are using or accessing Hissab on an iOS device,
          you acknowledge and agree to the terms of this clause. You acknowledge
          that these Terms of Service are between you and Rawbytes Technologies
          only, not with Apple Inc. (Apple), and Apple is not responsible for
          Hissab and any materials available in Hissab.{" "}
        </p>
        <p>
          Apple has no obligation to furnish you with any maintenance and
          support services with respect to Hissab.{" "}
        </p>
        <p>
          If Hissab fails to conform to any applicable warranty, you may notify
          ...
          to Hissab and any other claims, losses, liabilities, damages, costs,
        ...
        <p>
          ...
          party relating to Hissab or your use of Hissab, including but not
          ...
          requirement; and (3) claims arising under consumer protection or
          similar legislation.{" "}
        </p>
        <p>
        ...
        <p>
          ...
          Hissab, including any Usage Rules set forth in the Apple App Store
        ...
        <p>
          We may suspend or terminate your right to use Hissab and these Terms
        ...
        <p>
          ...
          with the laws of ON, Canada. You irrevocably submit to the exclusive
