...
import { type UseSupabaseUploadReturn } from "@/hooks/use-supabase-upload.ts";
  ...
  return (
    <DropzoneContext.Provider value={{ ...restProps }}>
      <div
        {...getRootProps({
          className: cn(
            "border-2 border-gray-300 rounded-xl p-6 text-center bg-card transition-colors duration-300 text-foreground",
            className,
